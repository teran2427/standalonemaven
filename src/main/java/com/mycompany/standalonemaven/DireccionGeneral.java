 ...
 * @author teran
 */
public class DireccionGeneral extends javax.swing.JFrame {

    private static DireccionGeneral direccionGeneral;
    static DireccionGeneral getInstance(){
    ...
    /**
     * Creates new form DireccionGeneral
     */
    private DireccionGeneral() {
        initComponents();
        ...
        try {
            ...
            String query = "SELECT "
                    ...
                    + "Departamento "
                    + "FROM Empleados "
                    + "WHERE Departamento = 'Direccion General' "
                    + "ORDER BY Nombre;";
