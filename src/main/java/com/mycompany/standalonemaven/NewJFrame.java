...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private static NewJFrame tablaPersonal;
    static NewJFrame getInstance(){
        if(tablaPersonal == null)
            tablaPersonal = new NewJFrame();
    ...
    private void initComponents() {
        ...
        if (tabla.getColumnModel().getColumnCount() > 0) {
            tabla.getColumnModel().getColumn(0).setHeaderValue("Numero_Empleado");
            tabla.getColumnModel().getColumn(1).setHeaderValue("Nombre");
            tabla.getColumnModel().getColumn(2).setHeaderValue("Telefono");
            tabla.getColumnModel().getColumn(3).setHeaderValue("Ext");
            tabla.getColumnModel().getColumn(4).setHeaderValue("Email");
            tabla.getColumnModel().getColumn(5).setHeaderValue("Cubiculo");
            tabla.getColumnModel().getColumn(6).setHeaderValue("Departamentos");
        }
